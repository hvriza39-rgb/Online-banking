...
export const metadata: Metadata = { title: "Sign In — NexaBank" };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-[#f8f9fb]">
        <div className="w-full max-w-[380px]">
          ...
          <div className="mb-7">
            <h1 className="text-[24px] font-black text-[#0c0e12] tracking-[-0.04em] mb-1.5">Welcome back</h1>
            <p className="text-[14px] text-[#4b5262]">Sign in to your account</p>
          </div>
          ...
          <p className="text-center text-[13.5px] text-[#9aa0ad] mt-5">
            ...
            <Link href="/register" className="text-[#0c0e12] font-bold underline underline-offset-2 hover:opacity-60 transition-opacity">
              Create one
            </Link>
          </p>
        </div>
