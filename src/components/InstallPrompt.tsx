      ...
      <div className="bg-[#0f2419] rounded-2xl shadow-2xl overflow-hidden">
        ...
        {iosExpanded && swReady && (
          <div className="border-t border-[#1a2e22] px-5 py-4 space-y-3">
            ...
            {[
              { icon: <Share className="w-4 h-4 text-[#4daa80]" />,     text: "Tap the Share button at the bottom of Safari" },
              { icon: <span className="text-[#4daa80] text-[13px] font-bold">+</span>, text: 'Scroll down and tap "Add to Home Screen"' },
              { icon: <Download className="w-4 h-4 text-[#4daa80]" strokeWidth={1.8} />, text: 'Tap "Add" in the top right corner' },
            ].map(({ icon, text }, i) => (
            ...
            <div className="flex items-center gap-2 pt-2 border-t border-[#1a2e22]">
              ...
              <p className="text-[10px] text-[#6a8c7a]">The share icon looks like a box with an arrow pointing up</p>
            </div>
          </div>
        )}
      </div>
