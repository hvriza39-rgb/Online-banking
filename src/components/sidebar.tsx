          ...
          <div>
            ...
            {isAdmin && (
              <div className="flex items-center gap-1 mt-0.5">
                <ShieldCheck className="w-2.5 h-2.5 text-[#5ec8b0]" />
                <span className="text-[10px] text-[#5ec8b0] font-medium uppercase tracking-wider">Admin</span>
              </div>
            )}
          </div>
        </div>
          ...
          return (
            <Link key={href} href={href}
              ...
              <div className={cn(
                ...
                active      ? "bg-[#5ec8b0]/10 text-[#5ec8b0]"
              ...
              {active && !highlight && (
                <div className="ml-auto w-1.5 h-1.5 rounded-full bg-[#5ec8b0] flex-shrink-0" />
              )}
            </Link>
          );
        })}
      ...
      <div className="relative px-3 pb-5 border-t border-white/[0.06] pt-3 space-y-1">
        {!isAdmin && (
          <div className={cn(
            ...
            isVerified
              ? "bg-[#5ec8b0]/10 text-[#5ec8b0] border border-[#5ec8b0]/20"
              : isPending
